      ...
      <div className="flex items-center py-4 px-4 border-b border-gray-700 justify-between h-16">
        ...
        <div className="relative text-gray-600 focus-within:text-gray-400">
          ...
          <input
            type="search"
            name="search"
            className="transition duration-150 ease-out py-2 text-sm text-white bg-gray-800 rounded-md pl-10 focus:outline-none focus:bg-white focus:text-gray-900 md:w-64"
